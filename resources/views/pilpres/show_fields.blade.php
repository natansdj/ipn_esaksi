...
<div class="form-group">
    ...
    <p>{!! $pilpres->created_at !!}</p>
</div>

<!-- Updated At Field -->
<div class="form-group">
    {!! Form::label('updated_at', 'Updated At:') !!}
    <p>{!! $pilpres->updated_at !!}</p>
</div>
